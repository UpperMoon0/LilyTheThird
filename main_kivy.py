...
class MainAppLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        tab_panel = TabbedPanel(do_default_tab=False, tab_pos='top_mid') # No default tab, tabs on top

        # --- Create and add VTube Tab ---
        ...
        tab_panel.default_tab = chat_tab_item

        # --- Create and add Discord Tab ---
